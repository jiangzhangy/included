...
<a href="<?php echo U(MODULE_NAME.'/'.$controller_name.'/add');?>" class="btn btn-success"><i class="icon-plus icon-white"></i>新增链接</a>
</div>
<h4><i class="icon-home"></i>链接列表</h4>
<hr/>
	<table class="table table-bordered table-wordpress postlist-table">
		...
		<tbody>
		    <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr class="tr-publish">
				...
				<td><a target="_blank" href="<?php echo $list['site_url'];?>"><?php echo $list['site_name'];?></a></td>
				<td><img src="<?php echo $list['logo'];?>" style="width:30px;height:30px;"/></td>
