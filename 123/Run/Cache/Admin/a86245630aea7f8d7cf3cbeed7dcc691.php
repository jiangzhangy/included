...
<div class="main span10">
    <h4><i class="icon-plus"></i>添加导航<a href="<?php echo U(MODULE_NAME.'/'.$controller_name.'/index');?>" class="pull-right" ><i class="icon-backward"></i> <strong>返回列表</strong></a></h4>
<hr>
		<form action="<?php echo U(MODULE_NAME.'/'.$controller_name.'/insert');?>" method="post" accept-charset="utf-8" class="well form-inline" id="f" onSubmit="return ajaxform(this,function(d){opt_ok_return(d)})">       
            ...
            <tr><td>
				...
				<td><input type="text" name="name" value="" id="name" class="span4"  />                </td>
			</tr>  
       <tr><td>
       ...
       <tr id="moudle_id" style="display:none"><td>
       ...
       <tr><td>
        ...
        <td><select name="open_type"><option value="_brank">新窗口</option><option value="_parent">当前窗口</option></select></td>
      </tr>           
       <tr><td>
