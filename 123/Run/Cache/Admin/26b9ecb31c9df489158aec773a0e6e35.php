...
<a href="<?php echo U(MODULE_NAME.'/'.$controller_name.'/add');?>" class="btn btn-success"><i class="icon-plus icon-white"></i> 添加文章</a>
</div>
<h4><i class="icon-home"></i>文章管理</h4>
<hr/>
	...
	<table class="table table-bordered table-wordpress postlist-table">
		...
		<tbody>
		    <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr class="tr-publish">
				...
				<td><a target="_blank" href="/content/<?php echo $list['id']; echo C('URL_HTML_SUFFIX');?>"><?php echo $list['title'];?></a></td>
                <td><?php echo getCateName($list['cate_id']);?></td>
